export const safetyTopics = {
  topics: [
    ...
    // ... (rest of the topics remain the same)
    {
      ...
      description:
        "Understanding and identifying phishing emails and SMS attacks.",
      subtopics: [
    ...
    },
    {
      ...
      description:
        "Understanding the dangers of physical access social engineering.",
      subtopics: [
    ...
    },
    {
      ...
      description:
        "Understanding the dangers of watering hole social engineering.",
      subtopics: [
...

    {
      ...
      description:
        "Practical steps to enhance personal and organizational security.",
      subtopics: [
